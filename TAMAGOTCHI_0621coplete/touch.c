...
TouchScreenDebouncer(void)
{
    ...
    user_X = ((user_X-650)*480) / (3520-650);
    user_Y = ((user_Y-1200)*272) / (2990-1200);

    //Uart_Printf("TEST 1 x : %d, y : %d \n\r", g_i16TouchMin, g_i16TouchY);
    //
...
TouchScreenInit(uint32_t ui32SysClock)
{
    ...
    //ROM_ADCSequenceConfigure(ADC0_BASE, 3, ADC_TRIGGER_TIMER, 2);
