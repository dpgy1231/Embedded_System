...
PinoutSet(void)
{
    ...
    //
        ...
        ROM_GPIOPinConfigure(GPIO_PJ6_LCDAC);     //CS
        ROM_GPIOPinConfigure(GPIO_PN6_LCDDATA13);
        ROM_GPIOPinConfigure(GPIO_PN7_LCDDATA12);
        ROM_GPIOPinConfigure(GPIO_PR0_LCDCP);     //RD
        ROM_GPIOPinConfigure(GPIO_PR1_LCDFP);     //RS
        ROM_GPIOPinConfigure(GPIO_PR2_LCDLP);     //WR
